...
import '../cluster_helpers/cluster_covers.dart';

class ClusterMap extends StatefulWidget {
  const ClusterMap({Key? key, required this.passengerCountCovers}) : super(key: key);

  final List<PassengerCountCover> passengerCountCovers;
  @override
  ClusterMapState createState() => ClusterMapState();
}
